...
module.exports = {
    ...
    //read limit all
    geLimitbook: (limit, page) => {
        let offset = limit * page - limit
        return new Promise((resolve, reject) => {
            //SELECT lb.*,ct.nama_kategori FROM library as lb inner join category as ct on lb.id_kategori = ct.id_category
            konaksi.query(`SELECT library.*,category.nama_kategori FROM library LEFT JOIN category ON library.id_kategori = category.id_category LIMIT ? OFFSET ? `,
